...
if os.path.isfile(config.dataset_path):
    ...
    # Need to modify the following path if config.dataset_path is a file.
    pathfile = [os.path.join(r'C:\Users\hbrch\Desktop\CIS700\img_align_celeba', x) for x in pathfile]
...
if config.load_model_dir != '':
    ...
    print('Loading done.')
ourModel.load_networks(getLatest(os.path.join('pretrained', '*.pth')))
